...
public class Order_Adapter extends RecyclerView.Adapter {

    private Fragment fragment;
    private List<OrderItem> orderItems;
    OrderListener orderListener;

    public Order_Adapter(Fragment fragment, List<OrderItem> orderItems) {
        this.fragment = fragment;
        this.orderItems = orderItems;
    }

    public Order_Adapter(OrderListener orderListener) {
