...
public class ProductNewAdapterHo extends RecyclerView.Adapter {

    private Fragment fragment;
    private List<ProductItem> productList;
    ProductOnclick productOnclick;

    public ProductNewAdapterHo(fragment_home activity, List<ProductItem> productList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemview = fragment.getLayoutInflater().inflate(R.layout.item_list_product_ho,parent,false);
